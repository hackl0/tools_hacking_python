...
Usage
    ...
    1 - Run the script using the command "python3 directory_enumerator.py <target_URL>" where <target_URL> is the URL of the web server you want to check directories for.
...
Exemple 
    ...
    python3 directory_enumerator.py 54.239.28.85
